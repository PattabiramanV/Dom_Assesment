...
if(product_name_box.value=="" && product_amount_box.value==""){
  ...
  expence_append_fun(product_name_box.value,product_amount_box.value)
 
  n_th_child_color_fun();
...
function expence_append_fun(x,y){
  ...
  let product_type=document.createElement("p");
  product_type.className="product_type";
  product_type.innerHTML=x;

  let expense_amount=document.createElement("span");
  expense_amount.innerHTML=y;
  ...
  history_box_parent.append(history_box,trash_btn);
  middle_Expense_List.append(history_box_parent);
trash_btn.addEventListener("click",function(){trah_Fun(this)})
}
...
function trah_Fun(x){
  ...
  if(confirm(`Do you want to delete the product ${x.previousElementSibling.firstElementChild.innerHTML}?!`)){
  
  let trash_btn_parent=x.parentElement.firstElementChild.lastElementChild;
...
//......................n-th_child_color_change..........................//

function n_th_child_color_fun(){
  let all_span_tag=document.querySelectorAll("span");

all_span_tag.forEach((span_tag,index)=>{
span_tag.parentElement.classList.remove("background_color")
    if(index%2==0){
      console.log(span_tag);
        all_span_tag[index].parentElement.classList.add("background_color");
    }
});
}
